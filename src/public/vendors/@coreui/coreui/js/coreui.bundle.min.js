...
!function (t, e) {
    ...
    if ("string" == typeof e && t) {
      ...
      if (f) f.oneOff = f.oneOff && o;else {
        var d = H(a, e.replace(x, "")),
            h = s ? function (t, e, n) {
          return function i(o) {
            for (var r = t.querySelectorAll(e), s = o.target; s && s !== this; s = s.parentNode) for (var a = r.length; a--;) if (r[a] === s) return i.oneOff && q.off(t, o.type, n), n.apply(s, [o]);
  ...
  var tt = {
    ...
    return n.toggle = function () {
      ...
      if (n) {
        ...
        if (i && "radio" === i.type) {
          if (i.checked && this._element.classList.contains("active")) t = !1;else {
  ...
  var at = {
    ...
    return n.next = function () {
      ...
      if (!(t > this._items.length - 1 || t < 0)) if (this._isSliding) q.one(this._element, ht, function () {
        return e.to(t);
      });else {
  ...
  var je = le({
    defaultModifiers: [{
      ...
      effect: function (t) {
        ...
        }), a && l.addEventListener("resize", n.update, ce), function () {
    ...
    return n.toggle = function () {
      ...
      if (!e || 2 !== e.button && ("keyup" !== e.type || "Tab" === e.key)) for (var n = tt.find('[data-toggle="dropdown"]'), i = 0, o = n.length; i < o; i++) {
        ...
        if (e && "click" === e.type && (a.clickEvent = e), s) {
          var l = s._menu;
          if (r.classList.contains("show")) if (!(e && ("click" === e.type && /input|textarea/i.test(e.target.tagName) || "keyup" === e.type && "Tab" === e.key) && r.contains(e.target))) if (!q.trigger(r, "hide.coreui.dropdown", a).defaultPrevented) {
            var c;
      ...
      function u(r) {
        if (l(r)) {
          ...
          var h = new Date().getTime(),
              p = h - i;
          p > 0 && (o.x = f / p, o.y = d / p, i = h), function (n, i) {
            var o = Math.floor(e.scrollTop),
                r = e.scrollLeft,
                s = Math.abs(n),
                a = Math.abs(i);
  ...
  var ti = "sidebar",
    ...
    return n.open = function (t) {
      ...
      if (Boolean(navigator.platform)) for (; t.length;) if (navigator.platform === t.pop()) return !0;
      return !1;
